...
a convenience function \Robject{mkingen} is available.

<<model_definition, echo=TRUE>>=
source("~/R/kinfit.kriemhild/pkg/mkin/R/mkingen.R")
SFO <- mkingen(spec = list(parent = list(type = "SFO", input = NA, output = NA)
summary(SFO)
@
